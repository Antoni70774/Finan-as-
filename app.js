...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const state = {
    ...
    expenseCategories: ['Alimentação', 'Transporte', 'Moradia', 'Lazer', 'Saúde', 'Emprestimo', 'cartão de Credito', 'Agua', 'Energia', 'Outros'],
    incomeCategories: ['Salário', 'Combustivel', 'Investimentos', 'Outros'], // ✅ revisado
  };
