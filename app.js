...
function renderGoals() {
  ...
  state.goals.forEach(goal => {
    ...
    card.innerHTML = `
      <span class="meta-title">${goal.nome}</span>
      <span class="meta-info">Valor: <strong>${formatCurrency(goal.valor)}</strong></span>
...
function renderPayables() {
  ...
  state.payables.forEach(p => {
    ...
    card.className = 'goal-card';
    card.innerHTML = `
      <span class="meta-title">${p.nome}</span>
      <span class="meta-info">Valor: ${formatCurrency(p.valor)}</span>
      <div class="goal-actions">
