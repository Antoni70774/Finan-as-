...
document.addEventListener('DOMContentLoaded', () => {
    const state = {
        ...
        expenseCategories: ['Supermercado', 'Transporte', 'Investimento', 'Moradia', 'Saúde', 'Cartão de Credito 1', 'Cartão de Credito 2', 'Agua', 'Internet Residencia', 'Plano Celular', 'Gás', 'Energia Eletrica', 'Emprestimos', 'Vestuario', 'Lazer', 'Outros'],
    ...
    document.getElementById('cancel-btn').addEventListener('click', () => closeModal(transactionModal));
    document.getElementById('add-goal-btn').addEventListener('click', () => {
        goalForm.reset();
        openModal(goalModal);
    });

    document.getElementById('cancel-goal-btn').addEventListener('click', () => closeModal(goalModal));
    ...
    document.getElementById('type-expense-btn').addEventListener('click', () => setTransactionType('expense'));
    document.getElementById('type-income-btn').addEventListener('click', () => setTransactionType('income'));
    ...
    function renderGoals() {
        ...
        state.goals.forEach(goal => {
            const progressPercent = Math.min((goal.current / goal.target) * 100, 100).toFixed(0);
            ...
            item.innerHTML = `
                ...
                <div class="goal-values">
                    ...
                    <button class="edit-goal-btn" onclick="editGoal('${goal.id}')">Editar</button>
                </div>
            `;
